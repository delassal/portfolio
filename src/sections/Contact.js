...
export function Contact() {
    return (
        <section id="contact" className="py-16 w-full max-w-full">
            <div className="mx-auto max-w-2xl lg:max-w-5xl">
                <div className="w-full text-center mb-12">
                    <h2 className="text-3xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 mb-8 inline-flex items-center">
                        Daniel El-Assal
                        <a href="https://linkedin.com/in/danielelassal" target="_blank" rel="noopener noreferrer" className="ml-3 text-zinc-400 hover:text-blue-500 transition-colors duration-300">
                            <FaLinkedin size={28} />
                        </a>
                    </h2>
                </div>
